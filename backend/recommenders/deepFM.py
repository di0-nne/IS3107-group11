...
#     hitrate_df.to_csv("deepfm_hitrate_results.csv", index=False)
#     metric_df.to_csv("deepfm_metrics_results.csv", index=False)

#     print("\nResults saved as 'deepfm_hitrate_results.csv' and 'deepfm_metrics_results.csv'.")